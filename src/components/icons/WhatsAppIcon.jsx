// Glifo de teléfono estilo Feather (mismo trazo que ThemeToggle) — se usa
// tanto en el ícono monocromo del footer como en el botón flotante, para
// no repetir el path SVG en dos archivos.
