...
export default function InfonavitSimulator() {
  ...
  return (
    <>
      <Seo title={t("infonavit.title")} description={t("infonavit.subtitle")} />

      <div className="container infonavit-page">
        <div className="section-heading" style={{ margin: "2.5rem auto 2rem" }}>
          <h2>{t("infonavit.title")}</h2>
          <p>{t("infonavit.subtitle")}</p>
        </div>
